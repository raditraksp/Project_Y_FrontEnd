...
export default function Home() {
    ...
    const getData = () => {
        ...
        axios.get('/products/popularproducts/home')
            .then(res => setProductsPopular(res.data))
            .catch(err => console.log({err}))
    } 
            ...
            <div>
                ...
                <div className="mx-auto" style={{width:'80%'}}>
                    ...
                    <div className="" style={{marginTop:100}}>
                        ...
                        <div className="row">
                            {renderProductsPopular()}
                        </div>
                    </div >
                    <div className="" style={{marginTop:100}}>
                    <div className="text-center mt-5">
                        <label className="h3 text-dark font-weight-bold pl-3 pt-3 text-decoration-none">Newest Products</label>
                    </div>
                    <div className="mt-3">
                        <div className="row">
                            {renderProducts()}
